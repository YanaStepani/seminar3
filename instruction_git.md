...
*Для просмотра* всех существующих в репозитории веток, используется команда

    git branch

Символ "*" указывает на текущую ветку, в которой мы находимся и изменения в которой записываются в коммит.

*Перемещение между ветками* осуществляется с помощью команды "checkout" + имя ветки:
