...
Для представления всех коммитов и веток в графическом виде к команде git log нужно доавить флажок --graph:
...
После слияния веток, ветки ставшие не актуальными нужно удалить с помощью команды "branch" с флажком -d + имя ветки, которую необходимо удалить:
